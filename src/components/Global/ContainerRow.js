...
import { EditTitle, TitleMake } from './Title'
...
export const SaveUpdateBtns = (props) => {
    return (
        <div className='row'>
            ...
            <div className='col-6   d-flex   justify-content-start'>
                <button type="submit" className="mt-4 btn   offset-6 col-6  " style={{ fontSize: "12px", backgroundColor: CommonLook.Commonskin.color, color: "#fff", fontWeight: "bolder" }} >
...
export const FormInnerRightPane = (props) => {
    return (
        <div className={`box col-lg-8 col-md-8 ms-3   formBox p-3 ${props.otherStyles} mt-${props.mt}`}  >
            <div className='form-row'>
...
export const FormFillPane = (props) => {
    return (
        <div className={`box col-lg-12 col-md-12 ms-3   formBox p-3 mt-${props.mt}`}  >
            <div className='form-row'>
...
export const ContainerRowBtwn = (props) => { /*Thsi is on the form fields*/
    return (
        <>
            <div className={`container ${props.formvisible ?'formPane':''}`}  >
...
export const ContainerRowBtwnMake = (props) => { /*Thsi is on the form fields*/
    return (
        <>
            <div className={`container ${props.formvisible ?'formPane':''}  ${props.otherStyles}`}   >
                <div className='row  d-flex justify-content-between align-top'>
                    {props.clearBtn && <EditTitle name={props.form} />}
                    {!props.clearBtn && <TitleMake name={props.form} />}
                    {props.children}
                </div>
            </div>
        </>
...
export const ContainerSingleRow = (props) => { /*Thsi is on the form fields*/
    return (
        <>
