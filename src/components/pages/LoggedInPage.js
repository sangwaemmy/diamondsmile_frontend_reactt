...
function LoggedInPage() {
  ...
  useEffect(() => {
    document.body.classList.remove(
      'removescrol','bg_pubAppointment','bg_createAccount'
    );
    ...
    <MDBContainer fluid >
      <MDBRow className='d-flex justify-content-center align-items-center'>
        <MDBCol col='12'>
          ...
          <MDBCard className='  my-1 mx-auto' style={loginNg}>
            <MDBCardBody className='p-5 d-flex flex-column align-items-center mx-auto w-100'>
              ...
              <MDBInput wrapperClass=' mx-5 w-100' onChange={(e) => setUsername(e.target.value)} label='Email address' id='formControlLg' type='email' size="md" />
              <MDBInput wrapperClass=' mx-5 w-100' onChange={(e) => setPassword(e.target.value)} label='Password' id='formControlLg' type='password' size="md" />
