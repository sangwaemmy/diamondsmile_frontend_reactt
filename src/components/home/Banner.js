...
function Banner() {
    ...
    const txtChanger = () => {
        if (countResetabble == 1) {
            setTxtDisplay("Stock checkout")
        } else if (countResetabble == 2) {
            setTxtDisplay("The stock will manage your items well")
        } else if (countResetabble == 3) {
            setTxtDisplay("The stock should be done effeciently")
        } else if (countResetabble == 4) {
            setTxtDisplay("Manage Finance and assets")

        } else if (countResetabble == 5) {
            setTxtDisplay("Check your Threshold")
        } else if (countResetabble == 6) {
            setTxtDisplay("Manage your Expiring items")
        }
    }
